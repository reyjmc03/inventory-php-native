...
{	
	...
	if(is_numeric($uid))
	{
		...
		$template = 'template/tpluserform.php';
	}
	else
	{
		header('location: user.php');
...
/* >>>>>>>>>> MASTER PAGE <<<<<<<<<< */
require_once('template/tplmaster.php');
?>